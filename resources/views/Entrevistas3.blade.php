<x-blog-layout>
    ...
    @endsection
    @section('content')
        <article class="container mx-auto  px-16 ">
            <h1 class="blogH1">
                La entrevista de trabajo
            </h1>
            ...
            <p class="blogParrafo">
                Cualquier entrevista te la pueden solicitar presencial o a distancia. Esta última puede ser telefónica o por
                videollamada.
            </p>
                ...
                <li class="list-none">
                    <ul class="blogUl4">
                        ...
                        <li class="">
                            ...
                            <p class="blogParrafo4">
                                Normalmente el entrevistador pregunta de manera directa al individuo cuál es su expectativa
