<x-app-layout>
    <div class="bg-gradient-to-r from-green-100 via-green-200 to-green-500 mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-10">
        <div class="grid grid-cols-2">
            <div class=flex-1>
                ...
                <p class="nivelp text-2xl italic leading-relaxed ">Durante la búsqueda de empleo, tu objetivo es ponerte en contacto con las empresas y convencerlas de tu idoneidad para el puesto de trabajo. </p>
            </div>
            <div class="items-center ml-10">
                <div class="bg-gray-100 border-2 rounded-lg shadow-lg ">

                        <div class="youtube-player max-w-7xl " data-id="YHgGcafQeio"></div>
                </div>
    ...
    <div class="container mx-auto text-xl leading-normal text-justify px-10 bg-white ">
        <div class="pt-10">
            <a class="text-2xl px-4 py-2 items-center font-semibold rounded-full bg-green-900 text-white" href="https://www.educaweb.com/" target="_blank"><span class=" font-extrabold text-green-100">
                <i class="fas fa-pen"></i>
                Fuente: </span>Euducaweb
            </a>
     </div>
        ...
        <h2 class="nivel2">Canales para buscar trabajo</h2>
        <h3 class="nivel3">Autocandidatura</h3>
